...
const Page2 = () => (
  <div id="page2">
    <div id="moving-text">
      {/* Similar content, using array map to reduce repetition */}
      {[...Array(3)].map((_, i) => (
    ...
    <div id="page2-bottom">
      ...
      <div id="bottom-part2">
        <img src="https://uploads-ssl.webflow.com/64d3dd9edfb41666c35b15b7/64d3dd9edfb41666c35b15d1_Holding_thumb-p-500.jpg" alt="Teamwork" />
